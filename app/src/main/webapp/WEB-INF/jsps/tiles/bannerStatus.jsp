                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">
                            <s:property value="%{getProp('site.name')}" />
                        </a>
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<s:url value='/'/>">
                                <s:property value="getProp('site.shortName')" />
                            </a></li>

                        <li>
                            <a href="<s:url action='menu' namespace='/roller-ui' />">
                                <s:text name="mainPage.mainMenu" />
                            </a>
                        </li>

                        <s:if test="authenticatedUser != null">
                            <li>
                                <a href="<s:url action='starredWeblogEntries' namespace='/roller-ui' />">
                                    <s:text name="Starred Posts" />
                                </a>
                            </li>
                            <li>
                                <a href="<s:url action='logout' namespace='/roller-ui' />">
                                    <s:text name="navigationBar.logout" />
                                </a>
                            </li>
                        </s:if>
                        <s:else>
                            <li>
                                <a href="<s:url action='login-redirect' namespace='/roller-ui' />">
                                    <s:text name="navigationBar.login" />
                                </a>
                            </li>

                            <s:if
                                test="getBooleanProp('users.registration.enabled') && getProp('authentication.method') != 'ldap'">
                                <li>
                                    <a href="<s:url action='register' namespace='/roller-ui' />">
                                        <s:text name="navigationBar.register" />
                                    </a>
                                </li>
                            </s:if>

                            <s:elseif
                                test="getProp('users.registration.url') != null && getProp('users.registration.url') > 0">
                                <li>
