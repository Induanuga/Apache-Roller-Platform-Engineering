...
public interface UserManager {
    ...
    void starWeblog(User user, Weblog weblog) throws WebloggerException;
    void unstarWeblog(User user, Weblog weblog) throws WebloggerException;
    boolean isWeblogStarred(User user, Weblog weblog) throws WebloggerException;
    List<Weblog> getStarredWeblogs(User user) throws WebloggerException;
    long getWeblogStarCount(Weblog weblog) throws WebloggerException;
    
    /**
     * Get star count for a weblog with guaranteed fresh data from database.
     * This method bypasses JPA query cache to ensure current count.
     * Use this after starring/unstarring to get immediate accurate result.
     *
     * @param weblog The weblog to count stars for
     * @return The current star count, fresh from database
     * @throws WebloggerException If there is a problem.
     */
    long getWeblogStarCountFresh(Weblog weblog) throws WebloggerException;

    void starWeblogEntry(User user, WeblogEntry entry) throws WebloggerException;
    void unstarWeblogEntry(User user, WeblogEntry entry) throws WebloggerException;
    boolean isWeblogEntryStarred(User user, WeblogEntry entry) throws WebloggerException;
    List<WeblogEntry> getStarredWeblogEntries(User user, int offset, int length) throws WebloggerException;
    long getWeblogEntryStarCount(WeblogEntry entry) throws WebloggerException;
    
    /**
     * Get star count for a weblog entry with guaranteed fresh data from database.
     * This method bypasses JPA query cache to ensure current count.
     * Use this after starring/unstarring to get immediate accurate result.
     *
     * @param entry The weblog entry to count stars for
     * @return The current star count, fresh from database
     * @throws WebloggerException If there is a problem.
     */
    long getWeblogEntryStarCountFresh(WeblogEntry entry) throws WebloggerException;

    /**
     * Get top N [WeblogEntry, Long starCount] pairs ordered by star count descending.
     * Uses a GROUP BY aggregate query — does NOT iterate individual articles.
     *
     * @param limit Maximum number of results to return.
     * @return List of Object[] where [0] is WeblogEntry and [1] is Long star count.
     */
    List<Object[]> getTopStarredWeblogEntries(int limit) throws WebloggerException;

    /**
     * Get top N [Weblog, Long starCount] pairs ordered by star count descending.
     * Uses a GROUP BY aggregate query — does NOT iterate individual articles.
     *
     * @param limit Maximum number of results to return.
     * @return List of Object[] where [0] is Weblog and [1] is Long star count.
     */
    List<Object[]> getTopStarredWeblogs(int limit) throws WebloggerException;
     ...
     * @throws WebloggerException If there is a problem.
     */
    void resetUserPassword(User user, String newPassword) throws WebloggerException;
