...
public class UserDataServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null && umgr.hasGlobalPermission(user, "admin")) {
                admin = true;
            }
            ...
            for (User u : users) {
                response.getWriter().print(u.getUserName());
                if (admin) {
                    response.getWriter().print(",");
                    response.getWriter().println(u.getEmailAddress());
                } else{
                    response.getWriter().print(",");
